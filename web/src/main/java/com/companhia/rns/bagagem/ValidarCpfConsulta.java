...
public class ValidarCpfConsulta implements IStrategy{

	@Override
	public String processar(EntidadeDominio entidade) {
		// TODO Auto-generated method stub
		Bagagem bagagem = (Bagagem) entidade;
		if(bagagem.getCliente() == null || !ValidarCpfConsulta.isCPF(bagagem.getCliente().getCpf())) {
			return "Cpf do cliente e invalido";
		}
		return null;
	}
